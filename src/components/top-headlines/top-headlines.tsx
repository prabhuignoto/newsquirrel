...
const TopHeadlines: React.SFC<ITopHeadlines> = ({
  appMode,
  searchTerm,
  country,
  category,
  ...
  return (
    <Wrapper data-testid="rt-top-headlines">
      ...
      <Toolbar appMode={appMode} className="columns is-multiline">
        <div
          className="column is-5-desktop is-6-fullhd is-12-tablet is-paddingless"
      ...
      {searchTerm ? (
        <SearchNews term={searchTerm} />
      ) : (
        <NewsStand
          country={country}
          category={category}
          quickViewUrl={quickView}
        />
      )}
